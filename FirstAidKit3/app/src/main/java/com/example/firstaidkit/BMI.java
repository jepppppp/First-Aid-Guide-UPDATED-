...
//                String calculatebmi = mcalculatebmi.getText().toString();
//
//
//                BMIuser user = new BMIuser(calculatebmi);
//                BMIDbRef.push().setValue(user);

                String currentheight = mcurrentheight.getText().toString();
                String currentweight = mcurrentweight.getText().toString();
                String currentage = mcurrentage.getText().toString();

                BMIuserTwo user = new BMIuserTwo(currentheight,currentweight,currentage);
                BMIDbRef.push().setValue(user);
                ...
                else if(intweight==0|| intweight<0)
                {
                    ...
                    Intent intent = new Intent(BMI.this, BMIpage2.class);
